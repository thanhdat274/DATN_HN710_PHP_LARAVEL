                        ...
                        <table id="bootstrap-data-table" class="table table-striped table-bordered" data-disable-sort="false">
                            ...
                            <tbody class="null_Table">
                                ...
                                <td class="d-flex">
                                    ...
                                    <a class="btn btn-warning mr-2" href="{{route('admin.category_blogs.edit', $item)}}" title="Sửa"><i class="fa fa-edit"></i></a>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Bạn có chắc chắn muốn xóa danh mục bài viết"{{ $item->name }}" không?
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-primary" data-dismiss="modal">Hủy</button>
                                                <form action="{{ route('admin.category_blogs.destroy', $item) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
