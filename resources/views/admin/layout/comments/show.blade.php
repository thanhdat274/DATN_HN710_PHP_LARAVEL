            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div>
                        <strong class="card-title">Chi tiết bình luận</strong>
                        <div class="">Tên sản phẩm: {{ $product->name }} </div>
                        </div>
                        <div>
                            ...
                            <tbody>
                                @foreach ($comments as $key => $comment)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <a class="btn btn-primary mr-2" href="{{ route('admin.comments.showChildren', $comment->id) }}" title="Xem chi tiết"><i
                                                    class="fa fa-eye"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
