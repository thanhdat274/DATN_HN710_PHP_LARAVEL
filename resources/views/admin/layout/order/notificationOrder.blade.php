                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('admin.notification') }}" class="btn btn-primary">
                                        ...
                                        @if ($order->status != 5 && $order->status != 4)
                                                ...
                                                @if ($order->status == 1)
                                                    @if ($canConfirm)
                                                        <button type="button" class="btn btn-success ml-2"
                                                            data-toggle="modal"
                                                            data-target="#confirmModal{{ $order->id }}"
                                                            title="Chờ lấy hàng">
                                                    ...
                                                    @else
                                                        <button type="button" class="btn btn-danger ml-2"
                                                            data-toggle="modal"
                                                            data-target="#cancelModal{{ $order->id }}" title="Đã hủy">
                                            ...
                                            @elseif($order->status == 2)
                                                <button type="button" class="btn btn-info ml-2" data-toggle="modal"
                                                    data-target="#shipModal{{ $order->id }}" title="Đang giao hàng">
                                                    <i class="fa fa-truck"></i>
                                                </button>
                                            @elseif($order->status == 3)
                                                <button type="button" class="btn btn-success ml-2" data-toggle="modal"
                                                    data-target="#successModal{{ $order->id }}"
